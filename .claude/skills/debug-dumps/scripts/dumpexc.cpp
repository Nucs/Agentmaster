...
int wmain(int argc, wchar_t** argv) {
    ...
    if (er.ExceptionCode == 0xC0000409 && er.NumberParameters >= 1) {
        ...
        switch (er.ExceptionInformation[0]) {
            ...
            case 0xA: n = L"FAST_FAIL_GUARD_ICALL_CHECK_FAILURE (CFG: indirect/virtual call through a freed/corrupt vtable)"; break;
            case 0xB: n = L"FAST_FAIL_GUARD_WRITE_CHECK_FAILURE"; break;
            case 0xC: n = L"FAST_FAIL_INVALID_FIBER_SWITCH"; break;
            case 0xD: n = L"FAST_FAIL_INVALID_SET_OF_CONTEXT"; break;
            case 0xE: n = L"FAST_FAIL_INVALID_REFERENCE_COUNT"; break;
