<!-- Agentmaster 0.5.3 release notes — PRE-RELEASE. DRAFT / SNAPSHOT (prepared ahead of the release round).
     Cumulative since v0.5.2 (d63cf610b). Snapshot @ HEAD 4895adc8c. 21 commits (19 feat/fix below +
     1 docs-only: 410c0b726 find-in-fleet design, omitted + 7e70e89cd a rename-cleanup folded into the
     unread-model bullet).
     STATUS AT PREP TIME (re-scan + refresh at the release round):
       * NOT fully pushed — origin/agentmaster is at d63cf610b (v0.5.2); local is ahead. Release round pushes + tags.
       * Minor uncommitted WIP (9 files, +46/-26) — looks like the waitingDecayMinutes -> waitingForYouTimeoutMinutes
         settings-rename cleanup; not a distinct user feature. Fold in if committed by release.
     PRERELEASE mechanics for the release round: publish with --prerelease and NOT --latest
       (0.5.2 stays the stable Latest; the in-app updater offers 0.5.3 only to users who enabled
       "Allow pre-release versions").
     Asset names: tag v0.5.3 -> 0.5.3.0. -->
