...
namespace winrt::Microsoft::Terminal::Control::implementation
{
    struct SearchBoxControl : SearchBoxControlT<SearchBoxControl>
    {
        ...
        bool HighlightAllMatches(); // Agentmaster: the "Highlight all matches" toggle state
        ...
        void HighlightAllButtonClicked(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e); // Agentmaster
