...
static void TestAppSettings()
{
    ...
    // Round-trip every field with non-default values.
    {
        ...
        in.summaryPanelTruncate = true; // non-default (default false = show everything)
        ...
        CHECK(out.summaryPanelTruncate == true, "settings summaryPanelTruncate round-trip");
    ...
    // Empty / garbage -> all defaults (a missing settings.json must change nothing).
    {
        ...
        CHECK(out.summaryPanelTruncate == false, "settings summaryPanelTruncate default false (show everything) on empty");
