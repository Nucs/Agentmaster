...
cl /std:c++20 /EHsc /nologo /W3 /Fe:m5_tests.exe m5_tests.cpp ..\SessionRegistry.cpp ..\HooksBridge.cpp ..\ClaudeSpawn.cpp ..\Persistence.cpp ..\SessionScanner.cpp ..\ProcessInspect.cpp ..\TranscriptStore.cpp ..\SessionSearch.cpp ..\Scheduler.cpp ole32.lib user32.lib oleaut32.lib
if errorlevel 1 (
