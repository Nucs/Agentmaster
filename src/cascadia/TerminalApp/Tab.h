...
namespace winrt::TerminalApp::implementation
{
    ...
    public:
        ...
        til::event<winrt::delegate<>> TagEditorRequested; // Agentmaster (bookmark tags): context-menu "Tag" -> page opens the tag panel for this tab's session (name a new tag + toggle the existing ones; an islands-safe Popup — a Flyout-hosted text box gets no keypresses)
