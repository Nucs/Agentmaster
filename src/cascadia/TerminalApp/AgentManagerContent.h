...
namespace winrt::TerminalApp::implementation
{
    ...
    private:
        ...
        winrt::Windows::UI::Xaml::Controls::ComboBox _setTabColorMode{ nullptr }; // TABS: HOW managed tabs are colored — shared per working dir (default) / individual per tab / inferred working dir (TabColorMode); GLOBAL, applied live on Save + cross-window broadcast
